class IscCircuitBreaker:
    """
    The IscCircuitBreaker class provides access to an Ipsa circuit breaker, to set and get data values.
    There are no analysis results associated with circuit breakers in this version.
    """
